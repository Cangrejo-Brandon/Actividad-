...
const catalogo_productos = [
    { id: 101, nombre: "Laptop Pro", precio: 1200, imagen: "https://via.placeholder.com/300x200?text=Laptop" },
    { id: 102, nombre: "Teclado Mecánico", precio: 85, imagen: "https://via.placeholder.com/300x200?text=Teclado" },
    { id: 103, nombre: "Monitor Ultra", precio: 450, imagen: "https://via.placeholder.com/300x200?text=Monitor" }
];

// --- RUTA PROTEGIDA PARA OBTENER EL CATÁLOGO ---
app.get('/api/catalogo', verifyToken, (req, res) => {
    // Si el middleware verifyToken pasa, significa que el usuario está autenticado.
    // Solo entonces enviamos los datos.
    console.log(`Usuario autenticado (ID: ${req.user.id}) solicitando el catálogo.`);
